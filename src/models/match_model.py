...
class Match:
    ...
    # available_players: list[Member] = field(default_factory=list)
    confirmed_players: list[Member] = field(default_factory=list)
    denied_players: list[Member] = field(default_factory=list)

    # Captains and teams
    attacking_captain: Optional[Member] = None
    attacking_team: list[Member] = field(default_factory=list)

    defending_captain: Optional[Member] = None
    defending_team: list[Member] = field(default_factory=list)
